...
- **Signed transactions.** Trading, sending a launch, routing fees: the transaction itself is what you sign, in your wallet, and that is the authorisation. No message.
