...
Everything the site does can be done through this API: read any coin's books, launch a coin on purps.lol, pump.fun or Robinhood Chain, wire an existing pump.fun coin's fees into a strategy, and steer a coin you own.
